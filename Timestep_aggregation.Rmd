...
WT_422s1 = agg(42_2_s1)
WT_423s1 = agg(42_3_s1) 
WT_423s2 = agg(42_3_s2) 
WT_423s3 = agg(42_3_s3) 
WT_424s1 = agg(42_4_s1) 
WT_424s2 = agg(42_4_s2) 
WT_424s3 = agg(42_4_s3) 
WT_424d1 = agg(42_4_d1) 
WT_424d2 = agg(42_4_d2) 
WT_522s1 = agg(52_2_s1) 
WT_523s1 = agg(52_3_s1) 
WT_523s2 = agg(52_3_s2) 
WT_523s3 = agg(52_3_s3) 
WT_524s1 = agg(52_4_s1) 
WT_524s2 = agg(52_4_s2) 
WT_524s3 = agg(52_4_s3) 
WT_524d1 = agg(52_4_d1) 
#WT_524d1 = agg(52_4_d2) 
#WT_862s1 = agg(86_2_s1)
WT_863s1 = agg(86_3_s1)
WT_863s2 = agg(86_3_s2)
WT_863s3 = agg(86_3_s3)
WT_864s1 = agg(86_4_s1_JB) 
WT_864s2 = agg(86_4_s2) 
WT_864s3 = agg(86_4_s3) 
